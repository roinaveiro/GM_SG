...
for MEAN in MEAN_GRID:
    for i in range(N_EXP):
        ...
        w_bw = train_nash_backward(learner_cost_flatten, attacker_cost_flatten,
            x_train_renom, LMB, MEAN, epochs=300, out_lr=10e-6, in_lr=0.01)
        #
        # Compute metrics
        ...
        pred_at = model(attack(w_nash_bw, b_nash_bw, x_test_renom, c_d, Z_TEST), w_nash, b_nash)
    ...
    #
    name = "results/nash_reg"+"mean"+str(MEAN)+".csv"
